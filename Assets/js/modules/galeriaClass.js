...
export default class Galeria extends Interface{
    ...
    interface(){
        ...
        <form id="formItem" name="formItem">
            <div class="mb-3 uploadImg">
                ...
                <label for="txtImg"><a class="btn btn-primary">Subir foto</a></label>
            ...
            <div class="mb-3">
                <label for="typeList" class="form-label">Categoria</label>
                <select class="form-select" aria-label="Default select example" id="typeList" name="typeList">
                    <option value="1">Cuadros decorativos</option>
                </select>
            </div>
            <div class="form-check mb-3">
                <label class="form-check-label" for="boolFrame">
                    ¿Está enmarcado?
                </label>
                <input class="form-check-input" type="checkbox" value="" id="boolFrame" name="boolFrame" checked>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
    ...
    addItem(element,strImg,strName,intPrice,intStock,strType,intWidth,intHeight){
        ...
        div.innerHTML = `
        <div class="row rounded-end shadow p-3 bg-body rounded item">
            <div class="col-md-2">
