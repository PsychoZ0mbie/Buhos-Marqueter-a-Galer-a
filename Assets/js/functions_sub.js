...
document.addEventListener('DOMContentLoaded',function(){
    tableSubcategorias = $('#tableSubcategorias').dataTable( {
        ...
        "ajax":{
            "url": " "+base_url+"/Marqueteria/getSubcategorias",
            "dataSrc":""
        },
        "columns":[
            {"data":"idsubtopic"},
    ...
    formCategoria.onsubmit = function(e) {
        ...
        let ajaxUrl = base_url+'/Marqueteria/setSubcategoria'; 
...
function fntEditInfo(element, idcategoria){
    ...
    let request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
    let ajaxUrl  = base_url+'/Marqueteria/getSubcategoria/'+idcategoria;
...
function fntDelInfo(idsubcategoria){
    ...
    swal({
        ...
        {
            let request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
            let ajaxUrl = base_url+'/Marqueteria/delSubcategoria/'+idsubcategoria;
