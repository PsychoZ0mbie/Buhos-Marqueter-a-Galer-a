...
tableProductos = $('#tableProductos').dataTable( {
    ...
    "ajax":{
        "url": " "+base_url+"/Marqueteria/getProductos",
        "dataSrc":""
    },
    "columns":[
        {"data":"reference"},
...
tablePapelera = $('#tablePaper').dataTable( {
    ...
    "ajax":{
        "url": " "+base_url+"/Marqueteria/getPapelera",
        "dataSrc":""
    },
    "columns":[
        {"data":"reference"},
...
window.addEventListener('load',function(){
    ...
    formProducto.onsubmit = function(e) {
        ...
        if(strNombre == '' ||  intPrecio == '' || intCantidad == '' 
        ...
        let ajaxUrl = base_url+'/Marqueteria/setProducto'; 
        ...
        inputUploadfile.addEventListener('change', function(){
            ...
            if(uploadFoto !=''){
                ...
                if(type != 'image/jpeg' && type != 'image/jpg' && type != 'image/png'){
                    ...
                    let request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
                    let ajaxUrl = base_url+'/Marqueteria/setImage'; 
...
function fntDelItem(element){
    ...
    let idProducto = document.querySelector("#idProducto").value;
    let request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
    let ajaxUrl = base_url+'/Marqueteria/delFile'; 
...
function fntEditInfo(idproducto){
    ...
    let request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
    let ajaxUrl  = base_url+'/Marqueteria/getProducto/'+idproducto;
...
function fntRecoveryInfo(idproducto){
    let request = (window.XMLHttpRequest) ? new XMLHttpRequest : new ActiveXObject("Microsoft.XMLHTTP");
    let ajaxUrl = base_url+"/Marqueteria/getRecoveryProducto/"+idproducto;
...
function fntDelfEver(idproducto){
    ...
    swal({
        ...
        if(isConfirm){
            let request = (window.XMLHttpRequest) ? new XMLHttpRequest : new ActiveXObject("Microsoft.XMLHTTP");
            let ajaxUrl = base_url+"/Marqueteria/deleteRecovery/"+idproducto;
            request.open("GET",ajaxUrl,true);
            request.send();
            divLoading.style.display = "flex";
            request.onreadystatechange= function(){
...
function fntDelInfo(idproducto){
    ...
    swal({
        ...
        {
            let request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
            let ajaxUrl = base_url+'/Marqueteria/delProducto/'+idproducto;
            let strData = "idproducto="+idproducto;
            request.open("POST",ajaxUrl,true);
            request.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
function fntTecnicas(){
    if(document.querySelector("#listTecnica")){
        ...
        let request = (window.XMLHttpRequest) ? new XMLHttpRequest() :new ActiveXObject('Microsoft.XMLHTTP');
        let ajaxUrl = base_url+'/Marqueteria/getSelectTecnica';
        request.open("GET",ajaxUrl,true);
        request.send();
