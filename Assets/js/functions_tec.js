...
document.addEventListener('DOMContentLoaded',function(){
    tableTecnicas = $('#tableTecnicas').dataTable( {
        ...
        "ajax":{
            "url": " "+base_url+"/Marqueteria/getTecnicas",
            "dataSrc":""
        },
        "columns":[
            {"data":"idtechnique"},
    ...
    formTecnicas.onsubmit = function(e) {
        ...
        let ajaxUrl = base_url+'/Marqueteria/setTecnica'; 
...
function fntEditInfo(element, idtecnica){
    ...
    let request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
    let ajaxUrl  = base_url+'/Marqueteria/getTecnica/'+idtecnica;
...
function fntDelInfo(idtecnica){
    ...
    swal({
        ...
        {
            let request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
            let ajaxUrl = base_url+'/Marqueteria/deltecnica/'+idtecnica;
