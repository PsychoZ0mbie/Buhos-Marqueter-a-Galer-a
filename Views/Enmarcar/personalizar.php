...
<main class="container mb-3">
        <h1 class="section--title">Enmarcar <?=$data['tipo']['name']?></h1>
                ...
                <div class="col-md-6 page mb-4">
                    <div class="mb-3">
                        ...
                        <div class="d-flex flex-wrap justify-content-center align-items-center mt-3">
                            <div class="orientation element--hover" onclick="selectOrientation(this)">
                ...
                <div class="col-md-6 page d-none">
                    <div class="mb-3">
                        ...
                        <div class="option--custom d-none">
                            ...
                            <div class="mb-3">
                                <span class="fw-bold">3. Elige el color del margen</span>
                                <div class="colors mt-3">
                                    <?php
                                        for ($i=0; $i < count($colores); $i++) { 
                                    ?>
                                    <div class="colors--item color--margin element--hover" onclick="selectActive(this,'.color--margin')">
                                        <div style="background-color:#<?=$colores[$i]['color']?>" title="<?=$colores[$i]['name']?>"></div>
                                    </div>
                                    <?php }?>
                                </div>
                            </div>
                            <div class="mb-3 borderColor">
                                <span class="fw-bold ">4. Elige el color del borde</span>
                                <div class="colors mt-3">
                                    <?php
                                        for ($i=0; $i < count($colores); $i++) { 
                                    ?>
                                    <div class="colors--item color--border element--hover" onclick="selectActive(this,'.color--border')">
                                        <div style="background-color:#<?=$colores[$i]['color']?>" title="<?=$colores[$i]['name']?>"></div>
                                    </div>
                                    <?php }?>
                                </div>
                        ...
                        <div class="text-center">
                            ...
                            <button type="button" class="btn btn-bg-1 mt-2">Agregar <i class="fa-solid fa-cart-shopping"></i></button>
                        </div>
                    </div>
                </div>
            </div>
