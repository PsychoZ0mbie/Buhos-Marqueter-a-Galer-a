  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class ="modal-title h4">Permisos</h5>
      ...
      <div class="col-md-12">
          <div class="tile">
            <form action="" id="formPermisos" name="formPermisos">
              <input type="hidden" id="idrole" name ="idrole" value ="<?= $data['idrole'];?>" required="">
                  ...
                  <tbody>
                    <?php 
                      ...
                      for ($i =0; $i < count ($modulos);$i++){
                        $permisos = $modulos[$i]['permits'];
                        $rCheck = $permisos['r'] == 1 ? "checked" : "";
                        $wCheck = $permisos['w'] == 1 ? "checked" : "";
                        $uCheck = $permisos['u'] == 1 ? "checked" : "";
                        $dCheck = $permisos['d'] == 1 ? "checked" : "";

                        $idmod = $modulos[$i]['idmodule'];
                    ?>
                    <tr>
                      <td>
                        <?= $no;?>
                        <input type="hidden" name="modulos[<?= $i; ?>][idmodule]" value="<?= $idmod ?>" required >
                      </td>
                      <td>
                        <?= $modulos[$i]['title']; ?>
                      </td>
