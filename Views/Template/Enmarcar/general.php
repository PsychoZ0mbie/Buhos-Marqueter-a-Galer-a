...
<main class="container mb-3">
    <h1 class="section--title" id="enmarcarTipo" data-route="<?=$data['tipo']['route']?>" data-name="<?=$data['tipo']['name']?>" data-id="<?=$data['tipo']['id']?>">Enmarcar <?=$data['tipo']['name']?></h1>
                ...
                <div class="frame">
                    ...
                    <div class="layout">
                        <div class="layout--img">
                            <img src="<?=media()."/images/uploads/titulo.png"?>" alt="Enmarcar <?=$data['tipo']['name']?>">
                        </div>
