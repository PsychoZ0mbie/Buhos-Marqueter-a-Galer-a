            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-9 col-md-12">
                    ...
                    <div class="pagination">
                        <a href="<?=base_url()."/tienda/buscar?".$urlSearch."&p=1".$urlSort?>" class="pagination-btn pagination-start"><i class="fas fa-angle-double-left" aria-hidden="true"></i></a>
                        <a href="<?=base_url()."/tienda/buscar?".$urlSearch."&p=".$prevPage.$urlSort?>" class="pagination-btn pagination-prev"><i class="fas fa-angle-left" aria-hidden="true"></i></a>
                        <div class="pagination-pag">
                            ...
                            ?>
                             <a href="<?=base_url()."/tienda/buscar?".$urlSearch."&p=".$button.$urlSort?>" class="page <?=$activeBtn?>"><?=$button?></a>
                            <?php $button++;}?>
                            </ul>
                        </div>
                        <a href="<?=base_url()."/tienda/buscar?".$urlSearch."&p=".$nextPage.$urlSort?>" class="pagination-btn pagination-next"><i class="fas fa-angle-right" aria-hidden="true"></i></a>
                        <a href="<?=base_url()."/tienda/buscar?".$urlSearch."&p=".$paginas.$urlSort?>" class="pagination-btn pagination-end"><i class="fas fa-angle-double-right" aria-hidden="true"></i></a>
                    </div>
                </div>
            </div>
        </div>
